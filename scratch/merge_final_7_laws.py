...
new_law_files = [
    "cambodian_investment_law.json",
    "cambodian_taxation_law.json",
    "cambodian_public_finance_law.json",
    "cambodian_environment_code.json",
    "cambodian_anti_human_trafficking_law.json",
    "cambodian_copyright_ip_law.json",
    "cambodian_social_security_nssf_law.json"
]
...
print(f"Successfully merged all 7 final legal frameworks into master vault. Total provisions in disk storage: {len(merged)}")
