...
new_law_files = [
    "cambodian_construction_traffic_law.json",
    "cambodian_judges_magistracy_statute.json",
    "cambodian_tourism_food_safety_law.json"
]
...
print(f"Successfully merged all 3 final legal frameworks into master vault. Total provisions in disk storage: {len(merged)}")
