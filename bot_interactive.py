        ...
        if "message" in update:
            ...
            if text.startswith("/start"):
                ...
                latest_text = (
                    ...
                    "🎯 *ព័ត៌មានទាន់ហេតុការណ៍៖ អតីតរដ្ឋមន្ត្រីការពារជាតិអ៊ុយក្រែនអំពាវនាវឱ្យមានការបោះឆ្នោត និង បំបែកចេញពីលោកហ្សេឡេនស្គី - លោកមីខៃឡូហ្វេដូរ៉ូវ*\n\n"
                    "📝 *ខ្លឹមសារព័ត៌មាន៖*\n"
                    "តាមប្រភពព័ត៌មានពីប្រព័ន្ធខួរក្បាលឆ្លាតវៃ Super Brain ៖ អតីតរដ្ឋមន្ត្រីការពារជាតិអ៊ុយក្រែនអំពាវនាវឱ្យមានការបោះឆ្នោត និង បំបែកចេញពីលោកហ្សេឡេនស្គី - លោកមីខៃឡូហ្វេដូរ៉ូវ\n\n"
                    "📊 *ការវិភាគ៖*\n"
                    ...
                    "• កម្រិតភាពជឿជាក់ (Credibility Score): `92.0%`\n"
                    "• ប្រភពដើម: `Super Brain System`\n"
