            ...
            try:
                with open(self.archive_file, "r", encoding="utf-8") as f:
                    ...
                    if isinstance(data, list):
                        bad_kw = ["កម្ពុជាពង្រឹង", "ឆបោក", "scam", "Scam", "បទល្មើសអនឡាញ", "អានបន្ដ"]
                        existing_data = [
                            d for d in data 
                            if not any(k in d.get("title", "") for k in bad_kw)
                            and not any(k in d.get("content", "") for k in bad_kw)
                        ]
        ...
        default_records = [
            {
                ...
                "source_name": "ក្រសួងការពារជាតិកម្ពុជា",
                "category": "សេចក្តីថ្លែងការណ៍ផ្លូវការ",
                "title": "ព្រះមហាក្សត្រ៖ សម្តេចតេជោ ហ៊ុន សែន នៅរួមសុខរួមទុក្ខជាមួយប្រជាពលរដ្ឋគ្រប់កាលៈទេសៈ",
